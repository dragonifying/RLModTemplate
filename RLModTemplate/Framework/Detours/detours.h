...
////////////////////////////////////////////////////////////// Code Functions.
//
PVOID WINAPI DetourFindFunction(_In_ LPCSTR pszRLModule,
...
BOOL WINAPI DetourSetCodeRLModule(_In_ HMODULE hRLModule,
                                _In_ BOOL fLimitReferencesToRLModule);
PVOID WINAPI DetourAllocateRegionWithinJumpBounds(_In_ LPCVOID pbTarget,
                                                  _Out_ PDWORD pcbAllocatedSize);

///////////////////////////////////////////////////// Loaded Binary Functions.
//
HMODULE WINAPI DetourGetContainingRLModule(_In_ PVOID pvAddr);
HMODULE WINAPI DetourEnumerateRLModules(_In_opt_ HMODULE hRLModuleLast);
PVOID WINAPI DetourGetEntryPoint(_In_opt_ HMODULE hRLModule);
ULONG WINAPI DetourGetRLModuleSize(_In_opt_ HMODULE hRLModule);
BOOL WINAPI DetourEnumerateExports(_In_ HMODULE hRLModule,
                                   _In_opt_ PVOID pContext,
                                   _In_ PF_DETOUR_ENUMERATE_EXPORT_CALLBACK pfExport);
BOOL WINAPI DetourEnumerateImports(_In_opt_ HMODULE hRLModule,
                                   _In_opt_ PVOID pContext,
                                   _In_opt_ PF_DETOUR_IMPORT_FILE_CALLBACK pfImportFile,
                                   _In_opt_ PF_DETOUR_IMPORT_FUNC_CALLBACK pfImportFunc);

BOOL WINAPI DetourEnumerateImportsEx(_In_opt_ HMODULE hRLModule,
                                     _In_opt_ PVOID pContext,
                                     _In_opt_ PF_DETOUR_IMPORT_FILE_CALLBACK pfImportFile,
...
PVOID WINAPI DetourFindPayload(_In_opt_ HMODULE hRLModule,
                               _In_ REFGUID rguid,
                               _Out_ DWORD *pcbData);
...
DWORD WINAPI DetourGetSizeOfPayloads(_In_opt_ HMODULE hRLModule);
...
typedef DWORD64 (NTAPI *PF_SymLoadRLModule64)(_In_ HANDLE hProcess,
                                            _In_opt_ HANDLE hFile,
                                            _In_ LPSTR ImageName,
                                            _In_opt_ LPSTR RLModuleName,
                                            _In_ DWORD64 BaseOfDll,
                                            _In_opt_ DWORD SizeOfDll);
typedef BOOL (NTAPI *PF_SymGetRLModuleInfo64)(_In_ HANDLE hProcess,
                                            _In_ DWORD64 qwAddr,
                                            _Out_ PIMAGEHLP_MODULE64 RLModuleInfo);
...
typedef struct _DETOUR_SYM_INFO
{
    ...
    PF_SymLoadRLModule64      pfSymLoadRLModule64;
    PF_SymGetRLModuleInfo64   pfSymGetRLModuleInfo64;
...
PVOID WINAPI DetourCopyInstruction##x(_In_opt_ PVOID pDst,              \
                                      ...
                                      _Out_opt_ LONG *plExtra);         \
                                                                        \
BOOL WINAPI DetourSetCodeRLModule##x(_In_ HMODULE hRLModule,                \
                                   _In_ BOOL fLimitReferencesToRLModule); \
