...
float VectorI::Dot(const VectorI& other) const
{
	return X * other.X + Y * other.Y + Z * other.Z;
}
...
{
	float pitchRad = Pitch * (PI / 32768.f); // Unreal Pitch units to radians
	float yawRad = Yaw * (PI / 32768.f);     // Unreal Yaw units to radians
