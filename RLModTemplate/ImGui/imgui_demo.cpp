...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        ImGui::Combo("Display RLMode", &display_mode, "Auto/Current\0None\0RGB Only\0HSV Only\0Hex Only\0");
        ImGui::SameLine(); HelpMarker(
    ...
    if (ImGui::TreeNode("Drag and Drop"))
    {
        ...
        if (ImGui::TreeNode("Drag and drop to copy/swap items"))
        {
            ...
            static int mode = 0;
            if (ImGui::RadioButton("Copy", mode == RLMode_Copy)) { mode = RLMode_Copy; } ImGui::SameLine();
            if (ImGui::RadioButton("Move", mode == RLMode_Move)) { mode = RLMode_Move; } ImGui::SameLine();
            if (ImGui::RadioButton("Swap", mode == RLMode_Swap)) { mode = RLMode_Swap; }
            ...
            for (int n = 0; n < IM_ARRAYSIZE(names); n++)
            {
                ...
                if (ImGui::BeginDragDropSource(ImGuiDragDropFlags_None))
                {
                    ...
                    if (mode == RLMode_Copy) { ImGui::Text("Copy %s", names[n]); }
                    if (mode == RLMode_Move) { ImGui::Text("Move %s", names[n]); }
                    if (mode == RLMode_Swap) { ImGui::Text("Swap %s", names[n]); }
                    ImGui::EndDragDropSource();
                }
                if (ImGui::BeginDragDropTarget())
                {
...
static void ShowDemoWindowPopups()
{
    ...
    if (!ImGui::CollapsingHeader("Popups & RLModal windows"))
        return;
    ...
    IMGUI_DEMO_MARKER("Popups/RLModals");
    if (ImGui::TreeNode("RLModals"))
    {
        ImGui::TextWrapped("RLModal windows are like popups but the user cannot close them by clicking outside.");
        ...
        if (ImGui::BeginPopupRLModal("Delete?", NULL, ImGuiWindowFlags_AlwaysAutoResize))
        {
        ...
        if (ImGui::BeginPopupRLModal("Stacked 1", NULL, ImGuiWindowFlags_MenuBar))
        {
            if (ImGui::BeginMenuBar())
            {
                if (ImGui::BeginMenu("File"))
            ...
            ImGui::Text("Hello from Stacked The First\nUsing style.Colors[ImGuiCol_RLModalWindowDimBg] behind it.");
            ...
            // Also demonstrate passing a bool* to BeginPopupRLModal(), this will create a regular close button which
            // will close the popup. Note that the visibility state of popups is owned by imgui, so the input value
            // of the bool actually doesn't matter here.
            bool unused_open = true;
            if (ImGui::BeginPopupRLModal("Stacked 2", &unused_open))
            {
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Colors"))
        {
            ...
            ImGui::SameLine(); ImGui::Checkbox("Only RLModified Colors", &output_only_modified);
...
struct MyDocument
{
    ...
    static void DisplayContents(MyDocument* doc)
    {
        ...
        ImGui::TextWrapped("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
        ImGui::PopStyleColor();
        if (ImGui::Button("RLModify", ImVec2(100, 0)))
            doc->Dirty = true;
        ImGui::SameLine();
...
void ShowExampleAppDocuments(bool* p_open)
{
    ...
    if (!close_queue.empty())
    {
        ...
        else
        {
            ...
            if (ImGui::BeginPopupRLModal("Save?", NULL, ImGuiWindowFlags_AlwaysAutoResize))
            {
