...
// [0x00020401] (FUNC_Final | FUNC_Native | FUNC_Public | FUNC_AllFlags)
// Parameter Info:
// EGFxScaleRLMode                  SM                             (CPF_Parm)

void UGFxMoviePlayer::SetViewScaleRLMode(EGFxScaleRLMode SM)
{
	static UFunction* uFnSetViewScaleRLMode = nullptr;

	if (!uFnSetViewScaleRLMode)
	{
		uFnSetViewScaleRLMode = UFunction::FindFunction("Function GFxUI.GFxMoviePlayer.SetViewScaleRLMode");
	}

	UGFxMoviePlayer_execSetViewScaleRLMode_Params SetViewScaleRLMode_Params;
	memset(&SetViewScaleRLMode_Params, 0, sizeof(SetViewScaleRLMode_Params));
	memcpy_s(&SetViewScaleRLMode_Params.SM, sizeof(SetViewScaleRLMode_Params.SM), &SM, sizeof(SM));

	this->ProcessEvent(uFnSetViewScaleRLMode, &SetViewScaleRLMode_Params, nullptr);
};
...
// [0x00020401] (FUNC_Final | FUNC_Native | FUNC_Public | FUNC_AllFlags)
// Parameter Info:
// EGFxTimingRLMode                 RLMode                           (CPF_Parm)

void UGFxMoviePlayer::SetTimingRLMode(EGFxTimingRLMode RLMode)
{
	static UFunction* uFnSetTimingRLMode = nullptr;

	if (!uFnSetTimingRLMode)
	{
		uFnSetTimingRLMode = UFunction::FindFunction("Function GFxUI.GFxMoviePlayer.SetTimingRLMode");
	}

	UGFxMoviePlayer_execSetTimingRLMode_Params SetTimingRLMode_Params;
	memset(&SetTimingRLMode_Params, 0, sizeof(SetTimingRLMode_Params));
	memcpy_s(&SetTimingRLMode_Params.RLMode, sizeof(SetTimingRLMode_Params.RLMode), &RLMode, sizeof(RLMode));

	this->ProcessEvent(uFnSetTimingRLMode, &SetTimingRLMode_Params, nullptr);
};
