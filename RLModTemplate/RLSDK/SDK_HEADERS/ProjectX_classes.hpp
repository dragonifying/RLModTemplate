...
// Enum ProjectX._Types_X.EConsoleQualityRLMode
enum class EConsoleQualityRLMode : uint8_t
{
	ConsoleQualityRLMode_Performance                     = 0,
	ConsoleQualityRLMode_Quality                         = 1,
	ConsoleQualityRLMode_END                             = 2
};
...
// Enum ProjectX.DynamicValue_X.EDynamicValueRLModType
enum class EDynamicValueRLModType : uint8_t
{
	RLModType_Add                                        = 0,
	RLModType_Multiply                                   = 1,
	RLModType_MultiplyAdd                                = 2,
	RLModType_Set                                        = 3,
	RLModType_END                                        = 4
};
...
public:
	...
	void SnapTransition();
	void PrintDebugInfo(class UDebugDrawer* Drawer);
	void ApplyCameraRLModifiers(float DeltaTime, struct FTPOV& OutPOV);
	...
	void eventRLModifyPostProcessSettings(struct FPostProcessSettings& PP);
	...
	void RLModifyCameraShakeScale(class UCameraShake* Shake, float NewScale);
...
public:
	...
	uint32_t                                           bCabinedRLModeStatusKnown : 1;                   // 0x0188 (0x0004) [0x0000000000002000] [0x00000004] (CPF_Transient)
	...
	struct FScriptDelegate                             __EventCabinedRLModeStatusKnown__Delegate;       // 0x0278 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	void ShowWelcomeToCabinedRLModeScreen();
	void ShowWelcomeNotCabinedRLModeScreen();
	bool IsInCabinedRLModeOrGuest();
	bool EnforceCabinedRLMode();
	void SetInCabinedRLMode(bool val);
	bool IsInCabinedRLMode();
	bool PromptForPin();
	void SetRequirePinForFriends(bool bVal);
	bool IsPinRequiredForFriends();
	void NotifyWhenCabinedRLModeStatusKnown(struct FScriptDelegate Callback);
	bool IsGuestAccount();
	...
	void OpenPS4DisplayRLMode(EPS4DisplayRLMode DisplayRLMode, TArray<class FString> optionalTargets, int32_t optionalServiceLabel);
	...
	void EventCabinedRLModeStatusKnown(class UOnlinePlayer_X* Player);
...
public:
	...
	class UError* ConvertError(class UEOS_ErrorResponse* ErrorResponse);
	void HandleRequestCabinedRLMode(class UCabinedRLModeResponse* ResponseAsObject, class UError* Error, int32_t ResponseCode);
	bool RequestCabinedRLMode();
	...
	void UpdateAgeGateRLModalScreen();
...
public:
	...
	class FString                                      LastRLModifiedTimestamp;                         // 0x00C0 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	void eventConstruct();
	static void HandleUnpause(class UNetRLMode_Networked* NetRLMode, class UMetricsSystem_X* Metrics, class UPauseMetricsState_X* State);
	static void HandlePause(class UNetRLMode_Networked* NetRLMode, class UMetricsSystem_X* Metrics, class UPauseMetricsState_X* State);
};
...
public:
	...
	uint8_t                                           UnknownData00[0x4];                            // 0x0064 (0x0004) MISSED OFFSET
	TArray<struct FRLModifierSubscription>               AllSubscriptions;                              // 0x0068 (0x0010) [0x0000000000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	void UnsubscribeRLModifiers();
	void RLModifyObjects(class UClass* ObjClass, struct FScriptDelegate ApplyCallback, struct FScriptDelegate optionalResetCallback);
	void Undo();
	void Apply();
};
...
public:
	...
	TArray<class UGameSetting_X*>                      GameRLModeMutatorSettingPresets;                 // 0x00B8 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
// Class ProjectX.ParticleRLModuleBeamTarget_X
// 0x0004 (0x010C - 0x0110)
class UParticleRLModuleBeamTarget_X : public UParticleRLModuleBeamTarget
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.ParticleRLModuleBeamTarget_X");
		}
...
// Class ProjectX.ParticleRLModuleLocationBoneSocket_X
// 0x0004 (0x00AC - 0x00B0)
class UParticleRLModuleLocationBoneSocket_X : public UParticleRLModuleLocationBoneSocket
{
public:
	uint8_t                                           UnknownData00[0x4];                            // 0x00AC (0x0004) MISSED OFFSET
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.ParticleRLModuleLocationBoneSocket_X");
		}
...
// Class ProjectX.ParticleRLModuleLocationSkelVertSurface_X
// 0x0000 (0x00D0 - 0x00D0)
class UParticleRLModuleLocationSkelVertSurface_X : public UParticleRLModuleLocationSkelVertSurface
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.ParticleRLModuleLocationSkelVertSurface_X");
		}
...
// Class ProjectX.ParticleRLModuleVelocitySurfaceNormal_X
// 0x0034 (0x0074 - 0x00A8)
class UParticleRLModuleVelocitySurfaceNormal_X : public UParticleRLModuleVelocityBase
{
public:
	uint8_t                                           UnknownData00[0x4];                            // 0x0074 (0x0004) MISSED OFFSET
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.ParticleRLModuleVelocitySurfaceNormal_X");
		}
...
// Class ProjectX.ParticleRLModuleVelocitySurfaceNormalStatic_X
// 0x0000 (0x00A8 - 0x00A8)
class UParticleRLModuleVelocitySurfaceNormalStatic_X : public UParticleRLModuleVelocitySurfaceNormal_X
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.ParticleRLModuleVelocitySurfaceNormalStatic_X");
		}
...
// Class ProjectX.ParticleRLModuleWind_X
// 0x0050 (0x0070 - 0x00C0)
class UParticleRLModuleWind_X : public UParticleRLModuleWorldForcesBase
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.ParticleRLModuleWind_X");
		}
...
public:
	...
	void GotoPrivateMatchMap(struct FName MapName, int32_t GameRLMode, class FString GameTags);
	void GotoNextPrivateMatchMap();
	void OnPrivateEventDestroyed();
	void GoInactive();
	class FString GetStartServerCommand();
	struct FName GetNextRandomMapName(int32_t GameRLMode, bool bStandardOnly, bool bRocketLabsMedleyOnly);
	struct FName GetNextMapName(int32_t optionalGameRLMode, bool optionalBStandardOnly, bool optionalBRocketLabsMedleyOnly);
...
public:
	...
	uint32_t                                           bEnforceCabinedRLMode : 1;                       // 0x0078 (0x0004) [0x0000000000000000] [0x00000008] 
	...
	class FString                                      CabinedRLModeURL;                                // 0x00D0 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
// Class ProjectX.CabinedRLModeResponse
// 0x0010 (0x0060 - 0x0070)
class UCabinedRLModeResponse : public UObject
{
public:
	TArray<struct FCabinedRLModeData>                    ArrayOfCabinedRLModeData;                        // 0x0060 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.CabinedRLModeResponse");
		}
...
public:
	...
	class FString                                      ExtraRLModeCategory;                             // 0x00F0 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
...
public:
	...
	uint32_t                                           bExtraRLMode : 1;                                // 0x009C (0x0004) [0x0000004000000001] [0x00000008] (CPF_Edit)
	...
	uint32_t                                           bSkipGameRLModeVerification : 1;                 // 0x009C (0x0004) [0x0000004000000001] [0x00004000] (CPF_Edit)
...
public:
	...
	void OnSnap();
	void RLModifyPostProcessSettings(struct FPostProcessSettings& PP);
	void ProcessViewRotation(float DeltaTime, struct FRotator& OutViewRotation, struct FRotator& OutDeltaRot);
	void UpdatePOV(float DeltaTime, struct FCameraOrientation& OutPOV);
	void Tick(float DeltaTime);
	void EndCameraState();
...
// Class ProjectX.CameraRLModifier_CameraShake_X
// 0x0004 (0x009C - 0x00A0)
class UCameraRLModifier_CameraShake_X : public UCameraRLModifier_CameraShake
{
public:
	uint8_t                                           UnknownData00[0x4];                            // 0x009C (0x0004) MISSED OFFSET
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.CameraRLModifier_CameraShake_X");
		}
...
public:
	...
	TArray<class UDynamicValueRLModifier_X*>             RLModifiers;                                     // 0x0070 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
...
public:
	...
	float GetValue();
	void Tick(float DeltaTime);
	void RemoveAllRLModifiers();
	void RemoveRLModifier(class UDynamicValueRLModifier_X* RLMod);
	class UDynamicValueRLModifier_X* AddRLModifier(class UDynamicValueRLModifier_X* RLMod);
	void eventConstruct();
};

// Class ProjectX.DynamicValueRLModifier_X
// 0x0018 (0x0060 - 0x0078)
class UDynamicValueRLModifier_X : public UObject
{
public:
	class FString                                      DisplayName;                                   // 0x0060 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
	EDynamicValueRLModType                               Type;                                          // 0x0070 (0x0001) [0x0000000000000001] (CPF_Edit)    
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.DynamicValueRLModifier_X");
		}
...
// Class ProjectX.DynamicValueRLModifierCurve_X
// 0x0030 (0x0078 - 0x00A8)
class UDynamicValueRLModifierCurve_X : public UDynamicValueRLModifier_X
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.DynamicValueRLModifierCurve_X");
		}
...
// Class ProjectX.DynamicValueRLModifierDuration_X
// 0x0024 (0x0078 - 0x009C)
class UDynamicValueRLModifierDuration_X : public UDynamicValueRLModifier_X
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.DynamicValueRLModifierDuration_X");
		}
...
public:
	...
	uint32_t                                           bExtraRLMode : 1;                                // 0x0098 (0x0004) [0x0000000000000001] [0x00000020] (CPF_Edit)
	...
	uint32_t                                           bSkipGameRLModeVerification : 1;                 // 0x0098 (0x0004) [0x0000000000000001] [0x00008000] (CPF_Edit)
...
// Class ProjectX.GFxRLModal_X
// 0x0068 (0x0060 - 0x00C8)
class UGFxRLModal_X : public UObject
{
public:
	class FString                                      ActionScriptRLModalName;                         // 0x0060 (0x0010) [0x0000000000400003] (CPF_Edit | CPF_Const | CPF_NeedCtorLink)
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.GFxRLModal_X");
		}

		return uClassPointer;
	};

	class UGFxRLModal_X* NotifyOnClosed(struct FScriptDelegate Callback);
	void Close();
	...
	class UGFxRLModal_X* AddButtonCallback(int32_t Index, struct FScriptDelegate OnClick);
	class UGFxRLModal_X* AddButton(class FString optionalLabel, struct FScriptDelegate optionalOnClick);
	class UGFxRLModal_X* AddCancelButton(class FString LocalizedText, struct FScriptDelegate optionalOnClick);
	class UGFxRLModal_X* SetCancellable(bool bCancellable);
	class UGFxRLModal_X* SetDefaultSelectedButtonIndex(int32_t buttonIndex);
	class UGFxRLModal_X* SetIcon(class FString IconName);
	class UGFxRLModal_X* SetBody(class FString LocalizedText);
	class UGFxRLModal_X* SetTitle(class FString LocalizedText);
	void SetGFxObject(class UGFxObject* Obj);
	void EventClosed(class UGFxRLModal_X* RLModal);
	void ClickDelegate(class UGFxRLModal_X* RLModal);
};
...
// Class ProjectX.NetRLModeBase
// 0x0000 (0x0060 - 0x0060)
class UNetRLModeBase : public UObject
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.NetRLModeBase");
		}
...
// Class ProjectX.NetRLMode_Networked
// 0x0000 (0x0060 - 0x0060)
class UNetRLMode_Networked : public UNetRLModeBase
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.NetRLMode_Networked");
		}
...
public:
	...
	static void PlayerAdded(class UPrimaryPlayer* PP, class UNetRLMode_DedicatedClient* NetRLMode, class APlayerReplicationInfo* PRI);
};

// Class ProjectX.NetRLMode_DedicatedClient
// 0x0000 (0x0060 - 0x0060)
class UNetRLMode_DedicatedClient : public UNetRLModeBase
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.NetRLMode_DedicatedClient");
		}
...
// Class ProjectX.NetRLMode_Authoritative
// 0x0000 (0x0060 - 0x0060)
class UNetRLMode_Authoritative : public UNetRLModeBase
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.NetRLMode_Authoritative");
		}
...
// Class ProjectX.NetRLMode_Client
// 0x0000 (0x0060 - 0x0060)
class UNetRLMode_Client : public UNetRLModeBase
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.NetRLMode_Client");
		}
...
// Class ProjectX.NetRLMode_DedicatedServer
// 0x0000 (0x0060 - 0x0060)
class UNetRLMode_DedicatedServer : public UNetRLModeBase
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.NetRLMode_DedicatedServer");
		}
...
// Class ProjectX.NetRLMode_ListenServer
// 0x0000 (0x0060 - 0x0060)
class UNetRLMode_ListenServer : public UNetRLModeBase
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.NetRLMode_ListenServer");
		}
...
// Class ProjectX.NetRLMode_Server
// 0x0000 (0x0060 - 0x0060)
class UNetRLMode_Server : public UNetRLModeBase
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.NetRLMode_Server");
		}
...
// Class ProjectX.NetRLMode_Standalone
// 0x0000 (0x0060 - 0x0060)
class UNetRLMode_Standalone : public UNetRLModeBase
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.NetRLMode_Standalone");
		}
...
// Class ProjectX.NetRLModeReplicator_X
// 0x0000 (0x0268 - 0x0268)
class ANetRLModeReplicator_X : public AReplicationInfo
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.NetRLModeReplicator_X");
		}
...
// Class ProjectX.NetRLModeSystem_X
// 0x0000 (0x0060 - 0x0060)
class UNetRLModeSystem_X : public UObject
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.NetRLModeSystem_X");
		}

		return uClassPointer;
	};

	static void AddRLModes(TArray<class UClass*>& NetRLModes);
	static void HandleDedicatedClient(class ANetRLModeReplicator_X* _, class UNetRLMode_Client* NetRLMode);
