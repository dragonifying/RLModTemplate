...
// Enum GFxUI.GFxMoviePlayer.GFxScaleRLMode
enum class EGFxScaleRLMode : uint8_t
{
	SM_NoScale                                         = 0,
	SM_ShowAll                                         = 1,
	SM_ExactFit                                        = 2,
...
// Enum GFxUI.GFxMoviePlayer.GFxTimingRLMode
enum class EGFxTimingRLMode : uint8_t
{
	TM_Game                                            = 0,
	TM_Real                                            = 1,
	TM_END                                             = 2
...
// Enum GFxUI.GFxMoviePlayer.GFxRenderTextureRLMode
enum class EGFxRenderTextureRLMode : uint8_t
{
	RTM_Opaque                                         = 0,
	RTM_Alpha                                          = 1,
...
public:
	...
	uint32_t                                           bIsSplitscreenLayoutRLModified : 1;              // 0x0128 (0x0004) [0x0000000000002000] [0x00040000] (CPF_Transient)
	...
	EGFxTimingRLMode                                     TimingRLMode;                                    // 0x0188 (0x0001) [0x0000000000000000]               
	EGFxRenderTextureRLMode                              RenderTextureRLMode;                             // 0x0189 (0x0001) [0x0000000000000000]               
...
public:
	...
	void SetViewScaleRLMode(EGFxScaleRLMode SM);
	...
	void SetTimingRLMode(EGFxTimingRLMode RLMode);
...
public:
	...
	EGFxRenderTextureRLMode                              RenderTextureRLMode;                             // 0x017C (0x0001) [0x0000000000000001] (CPF_Edit)    
