...
public:
	...
	void OpenPS4DisplayRLMode(uint8_t LocalUserNum, EPS4DisplayRLMode DisplayRLMode, TArray<class FString> optionalTargets, int32_t optionalServiceLabel);
...
public:
	...
	struct FMap_Mirror                                 AccountsAcceptedVoiceRLModerationEULAMap;        // 0x00A8 (0x0050) [0x0000004000001000] (CPF_Native)  
...
public:
	...
	bool CheckAllPlayersAcceptedVoiceRLModerationAgreement();
