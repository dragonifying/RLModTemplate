...
// ScriptStruct Engine.AnimSequence.TimeRLModifier
// 0x0008
struct FTimeRLModifier
{
	float                                              Time;                                          // 0x0000 (0x0004) [0x0000000000000001] (CPF_Edit)    
	float                                              TargetStrength;                                // 0x0004 (0x0004) [0x0000000000000001] (CPF_Edit)    
};

// ScriptStruct Engine.AnimSequence.SkelControlRLModifier
// 0x0018
struct FSkelControlRLModifier
{
	struct FName                                       SkelControlName;                               // 0x0000 (0x0008) [0x0000000000000001] (CPF_Edit)    
	TArray<struct FTimeRLModifier>                       RLModifiers;                                     // 0x0008 (0x0010) [0x0000000004400001] (CPF_Edit | CPF_NeedCtorLink | CPF_EditInline)
};
...
{
	uint32_t                                           bDebugRLMode : 1;                                // 0x0000 (0x0004) [0x0000000000000001] [0x00000001] (CPF_Edit)
...
{
	uint8_t                                            OverrideRLMode;                                  // 0x0000 (0x0001) [0x0000000000000001] (CPF_Edit)    
	uint8_t                                           UnknownData00[0x3];                               		// 0x0001 (0x0003) MISSED OFFSET
...
// ScriptStruct Engine.CameraRLModifier_CameraShake.CameraShakeInstance
// 0x00A0
...
struct FMobileDistanceFieldParams
{
	...
	int32_t                                            BlendRLMode;                                     // 0x0050 (0x0004) [0x0000000000000000]               
};
...
struct FSeqVarLink
{
	...
	uint32_t                                           bRLModifiesLinkedObject : 1;                     // 0x0038 (0x0004) [0x0000000000000000] [0x00000004] 
...
struct FRawInputKeyEventData
{
	...
	uint8_t                                            RLModifierKeyFlags;                              // 0x0008 (0x0001) [0x0000000000000000]               
};
...
struct FPresetGeneratedPoint
{
	...
	uint8_t                                            IntepRLMode;                                     // 0x0014 (0x0001) [0x0000000000000000]               
};
...
struct FCurveParameterPoint
{
	...
	uint8_t                                            InterpRLMode;                                    // 0x0030 (0x0001) [0x0000000000000001] (CPF_Edit)    
};
...
struct FFontImportOptionsData
{
	...
	uint32_t                                           bEnableLegacyRLMode : 1;                         // 0x0098 (0x0004) [0x0000000000000001] [0x00000001] (CPF_Edit)
...
// ScriptStruct Engine.WorldInfo.ApexRLModuleDestructibleSettings
// 0x0014
struct FApexRLModuleDestructibleSettings
{
...
struct FLensFlareElement
{
	...
	uint32_t                                           bRLModulateColorBySource : 1;                    // 0x000C (0x0004) [0x0000000000000001] [0x00000008] (CPF_Edit)
...
// ScriptStruct Engine.ParticleRLModule.ParticleCurvePair
// 0x0018
...
// ScriptStruct Engine.ParticleRLModule.ParticleRandomSeedInfo
// 0x0020
...
// ScriptStruct Engine.ParticleRLModuleAttractorBoneSocket.AttractLocationBoneSocketInfo
// 0x0014
...
// ScriptStruct Engine.ParticleRLModuleBeamRLModifier.BeamRLModifierOptions
// 0x0004
struct FBeamRLModifierOptions
{
	uint32_t                                           bRLModify : 1;                                   // 0x0000 (0x0004) [0x0000000000000001] [0x00000001] (CPF_Edit)
...
// ScriptStruct Engine.ParticleRLModuleCollision.ParticleAttractorCollisionAction
// 0x0018
...
// ScriptStruct Engine.ParticleRLModuleEventGenerator.ParticleEvent_GenerateInfo
// 0x0030
struct FParticleEvent_GenerateInfo
{
	...
	uint8_t                                           UnknownData01[0x4];                               		// 0x001C (0x0004) MISSED OFFSET
	TArray<class UParticleRLModuleEventSendToGame*>      ParticleRLModuleEventsToSendToGame;              // 0x0020 (0x0010) [0x0000000004400001] (CPF_Edit | CPF_NeedCtorLink | CPF_EditInline)
};

// ScriptStruct Engine.ParticleRLModuleLocationBoneSocket.LocationBoneSocketInfo
// 0x0014
...
// ScriptStruct Engine.ParticleRLModuleOrbit.OrbitOptions
// 0x0004
...
// ScriptStruct Engine.ParticleRLModuleParameterDynamic.EmitterDynamicParameter
// 0x0040
...
// ScriptStruct Engine.ParticleRLModuleTypeDataBeam2.BeamTargetData
// 0x000C
...
// ScriptStruct Engine.ParticleRLModuleTypeDataPhysX.PhysXEmitterVerticalLodProperties
// 0x0010
...
struct FSkeletalMeshOptimizationSettings
{
	...
	uint8_t                                            NormalRLMode;                                    // 0x0008 (0x0001) [0x0000000020000000]  CPF_Deprecated)
	uint8_t                                           UnknownData00[0x3];                               		// 0x0009 (0x0003) MISSED OFFSET
...
// ScriptStruct Engine.SoundRLMode.SoundClassAdjuster
// 0x001C
...
// ScriptStruct Engine.SoundRLMode.AudioEQEffect
// 0x0024
