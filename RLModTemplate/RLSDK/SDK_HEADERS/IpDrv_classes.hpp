...
#define CONST_RECMODEPROVIDERTAG                                "PlaylistsRecRLMode"
...
// Enum IpDrv.InternetLink.ELinkRLMode
enum class ELinkRLMode : uint8_t
{
	MODE_Text                                          = 0,
	MODE_Line                                          = 1,
	MODE_Binary                                        = 2,
...
// Enum IpDrv.InternetLink.EReceiveRLMode
enum class EReceiveRLMode : uint8_t
{
	RMODE_Manual                                       = 0,
	RMODE_Event                                        = 1,
	RMODE_END                                          = 2
...
// Enum IpDrv.InternetLink.ELineRLMode
enum class ELineRLMode : uint8_t
{
	LMODE_auto                                         = 0,
	LMODE_DOS                                          = 1,
	LMODE_UNIX                                         = 2,
...
{
public:
	ELinkRLMode                                          LinkRLMode;                                      // 0x0268 (0x0001) [0x0000000000000000]               
	ELineRLMode                                          InLineRLMode;                                    // 0x0269 (0x0001) [0x0000000000000000]               
	ELineRLMode                                          OutLineRLMode;                                   // 0x026A (0x0001) [0x0000000000000000]               
	EReceiveRLMode                                       ReceiveRLMode;                                   // 0x026B (0x0001) [0x0000000000000000]               
...
public:
	...
	TArray<class UUIResourceDataProvider*>             RecRLModeDataProviders;                          // 0x00D8 (0x0010) [0x0000000000400002] (CPF_Const | CPF_NeedCtorLink)
