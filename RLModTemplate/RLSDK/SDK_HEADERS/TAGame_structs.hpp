...
// ScriptStruct TAGame._Types_TA.OnlineXPRLModifier
// 0x0038
struct FOnlineXPRLModifier
{
	struct FName                                       Name;                                          // 0x0000 (0x0008) [0x0000000040000000] (CPF_EditInlineNotify)
	float                                              RLModifier;                                      // 0x0008 (0x0004) [0x0000000040000000] (CPF_EditInlineNotify)
	uint8_t                                            RLModifierType;                                  // 0x000C (0x0001) [0x0000000040000000] (CPF_EditInlineNotify)
...
struct FOnlineXPReward
{
	...
	TArray<struct FOnlineXPRLModifier>                   RewardRLModifiers;                               // 0x0030 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
...
// ScriptStruct TAGame._Types_TA.GameRLModeData
// 0x001C
struct FGameRLModeData
{
	int32_t                                            GameRLMode;                                      // 0x0000 (0x0004) [0x0000000040000000] (CPF_EditInlineNotify)
	uint8_t                                           UnknownData00[0x4];                               		// 0x0004 (0x0004) MISSED OFFSET
...
// ScriptStruct TAGame.GFxData_Mutators_TA.RLModeMapPair
// 0x000C
struct FRLModeMapPair
{
	int32_t                                            GameRLMode;                                      // 0x0000 (0x0004) [0x0000000000000000]               
...
// ScriptStruct TAGame.GFxData_ErrorRLModals_TA.PendingError
// 0x0028
struct FPendingError
{
	...
	class UClass*                                      RLModalClass;                                    // 0x0020 (0x0008) [0x0000000000000000]               
};
...
struct FTourServerSettings
{
	...
	uint8_t                                            GameRLMode;                                      // 0x0021 (0x0001) [0x0001000000000000]               
...
struct FTourSearchSettings
{
	...
	TArray<int32_t>                                    GameRLModes;                                     // 0x0018 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
...
// ScriptStruct TAGame.CrowdActor_TA.CrowdNoiseRLModifierInstance
// 0x0008
struct FCrowdNoiseRLModifierInstance
{
...
{
	class UStatEvent_TA*                               StatEvent;                                     // 0x0000 (0x0008) [0x0000000000020001] (CPF_Edit | CPF_EditConst)
	class UCrowdNoiseRLModifier_TA*                      Noise;                                         // 0x0008 (0x0008) [0x0000000004000001] (CPF_Edit | CPF_EditInline)
};
...
struct FUserVoiceSettings
{
	...
	uint8_t                                            VoiceInputRLMode;                                // 0x0001 (0x0001) [0x0001000000000000]               
	uint8_t                                           UnknownData00[0x2];                               		// 0x0002 (0x0002) MISSED OFFSET
...
// ScriptStruct TAGame.FreeplayCommandsStatics_TA.RLModifyRBStateInParams
// 0x0064
struct FRLModifyRBStateInParams
{
...
struct FGFxMapData
{
	...
	int32_t                                            GameRLMode;                                      // 0x0030 (0x0004) [0x0000000000000000]               
};
...
// ScriptStruct TAGame.GFxData_ReplayViewer_TA.LocalizedCameraRLMode
// 0x0030
struct FLocalizedCameraRLMode
{
	struct FName                                       Name;                                          // 0x0000 (0x0008) [0x0000000040000000] (CPF_EditInlineNotify)
...
// ScriptStruct TAGame.GFxData_SeasonRLMode_TA.GFxLogoData
// 0x002C
struct FGFxLogoData
{
...
// ScriptStruct TAGame.GFxData_SeasonRLMode_TA.GFxBotData
// 0x0020
struct FGFxBotData
{
...
// ScriptStruct TAGame.GFxData_TrainingRLModeBrowser_TA.FavoritedFileMetaData
// 0x0028
...
// ScriptStruct TAGame.GFxData_TrainingRLModeBrowser_TA.CachedDownloadedFile
// 0x0020
...
// ScriptStruct TAGame.GFxData_TrainingRLModeBrowser_TA.SearchCacheData
// 0x0018
struct FSearchCacheData
{
	float                                              TimeoutTime;                                   // 0x0000 (0x0004) [0x0000000000002000] (CPF_Transient)
	uint8_t                                           UnknownData00[0x4];                               		// 0x0004 (0x0004) MISSED OFFSET
	TArray<class UTrainingEditorData_TA*>              TrainingRLModes;                                 // 0x0008 (0x0010) [0x0000000000402000] (CPF_Transient | CPF_NeedCtorLink)
};
...
// ScriptStruct TAGame.GFxData_TrainingRLModeConstants_TA.TrainingRLModeDifficulty
// 0x0001
struct FTrainingRLModeDifficulty
{
	uint8_t                                            Difficulty;                                    // 0x0000 (0x0001) [0x0000000040000000] (CPF_EditInlineNotify)
};

// ScriptStruct TAGame.GFxData_TrainingRLModeConstants_TA.TrainingRLModeType
// 0x0001
struct FTrainingRLModeType
{
	uint8_t                                            Type;                                          // 0x0000 (0x0001) [0x0000000040000000] (CPF_EditInlineNotify)
};

// ScriptStruct TAGame.GFxData_TrainingRLModeConstants_TA.TrainingRLModeTag
// 0x0001
struct FTrainingRLModeTag
{
...
struct FSceneFrameCapture
{
	...
	struct FName                                       CameraRLModeName;                                // 0x0008 (0x0008) [0x0000000000000000]               
