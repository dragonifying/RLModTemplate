...
// [0x00024001] 
struct UOnlineSubsystemEOS_execOpenPS4DisplayRLMode_Params
{
	uint8_t                                            LocalUserNum;                                     		// 0x0000 (0x0001) [0x0000000000000080] (CPF_Parm)    
	uint8_t                                            DisplayRLMode;                                      		// 0x0001 (0x0001) [0x0000000000000080] (CPF_Parm)    
...
// [0x00020401] 
struct UOnlineVoiceInterfaceEOS_execCheckAllPlayersAcceptedVoiceRLModerationAgreement_Params
{
	uint32_t                                           ReturnValue : 1;                                  		// 0x0000 (0x0004) [0x0000000000000580] [0x00000001] (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
};
