...
struct FInterpCurvePointVector2D
{
	...
	uint8_t                                            InterpRLMode;                                    // 0x002C (0x0001) [0x0000000000000001] (CPF_Edit)    
};
...
struct FInterpCurvePointFloat
{
	...
	uint8_t                                            InterpRLMode;                                    // 0x0018 (0x0001) [0x0000000000000001] (CPF_Edit)    
};
...
struct FInterpCurvePointVector
{
	...
	uint8_t                                            InterpRLMode;                                    // 0x0040 (0x0001) [0x0000000000000001] (CPF_Edit)    
};
...
struct FInterpCurvePointLinearColor
{
	...
	uint8_t                                            InterpRLMode;                                    // 0x0054 (0x0001) [0x0000000000000001] (CPF_Edit)    
};
...
struct FInterpCurvePointQuat
{
	...
	uint8_t                                            InterpRLMode;                                    // 0x0060 (0x0001) [0x0000000000000001] (CPF_Edit)    
};
...
struct FInterpCurvePointTwoVectors
{
	...
	uint8_t                                            InterpRLMode;                                    // 0x007C (0x0001) [0x0000000000000001] (CPF_Edit)    
};
